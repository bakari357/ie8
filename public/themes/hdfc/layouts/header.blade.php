		...
		<div class="navbar mtnav">
			...
			<div class="container offset-3">
			  ...
			  <div class="navbar-header">
				...
				<a href="index.html" class="navbar-brand"><img src="{{Theme::asset()->url('images/logo.png')}}" alt="Travel Agency Logo" class="logo"/></a>
			  </div>
					  ...
					  <li>
							<div class="row dropwidth01">
								...
								<ul class="droplist col-md-4">
								  ...
								  <li><a href="z-new-homepage.html">Listing link</a>  <span class="glyphicon glyphicon-star lblue"></span></li>
			...
			<div class="fullscreenbanner">
				<ul>
					...
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						<img src="{{Theme::asset()->url('images/slider/santorini.jpg')}}" alt=""/>
					...
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						...
						<img src="{{Theme::asset()->url('images/slider/paris.jpg')}}" alt=""/>
						<div class="tp-caption scrolleffect sft"
							 data-x="center"
							 data-y="120"
							 data-speed="1000"
					...
					<!-- FADE -->
					<li data-transition="fade" data-slotamount="1" data-masterspeed="300"> 										
						<img src="{{Theme::asset()->url('images/slider/rome.jpg')}}" alt=""/>
						<div class="tp-caption scrolleffect sft"
							 data-x="center"
							 data-y="120"
							 data-speed="1000"
	...
	<div class="wrap cstyle03">
		  ...
		  <div class="row">
							...
							<div class="room2 none">
								...
								<div class="w50percent">
									<div class="wh90percent textleft">
										...
										<div class="addroom2 block grey"><a href="#" onclick="addroom3()" class="grey">+ Add room</a> | <a href="#" onclick="removeroom2()" class="orange"><img src="{{Theme::asset()->url('images/delete.png')}}" alt="delete"/></a></div>
									</div>
								</div>
							...
							<div class="room3 none">
								...
								<div class="w50percent">
									<div class="wh90percent textleft">
										...
										<div class="addroom3 block grey"><a href="#" onclick="addroom3()" class="grey">+ Add room</a> | <a href="#" onclick="removeroom3()" class="orange"><img src="{{Theme::asset()->url('images/delete.png')}}" alt="delete"/></a></div>
									</div>
								</div>
			...
			<div class="col-md-4">
				<div class="shadow cstyle05">
					<div class="fwi one"><img src="{{Theme::asset()->url('images/rome.jpg')}}" alt="" /><div class="mhover none"><span class="icon"><a href="list2.html"><img src="{{Theme::asset()->url('images/spacer.png')}}" alt=""/></a></span></div></div>
					<div class="ctitle">Rome<a href="list2.html"><img src="{{Theme::asset()->url('images/spacer.png')}}" alt=""/></a>
						<span>$59.99</span>
					</div>
				</div>
			</div>
			<div class="col-md-4">
				<div class="shadow cstyle05">
					<div class="fwi one"><img src="images/surfer.jpg" alt="" /><div class="mhover none"><span class="icon"><a href="list2.html"><img src="images/spacer.png" alt=""/></a></span></div></div>
					<div class="ctitle">Cote d'azur<a href="list2.html"><img src="{{Theme::asset()->url('images/spacer.png')}}" alt=""/></a>
						<span>$59.99</span>
					</div>
				</div>			
			</div>
		...
		<div class="lastminute">
			<div class="container lmc">	
				<img src="{{Theme::asset()->url('images/rating-4.png')}}" alt=""/><br/>
			  ...
			  <div class="col-md-9">
				...
				<div class="wrapper">
					<div class="list_carousel">
						<ul id="foo">
							<li>
								<a href="list4.html"><img src="{{Theme::asset()->url('images/thumb-hawaii.jpg')}}" alt=""/></a>
								<div class="m1">
							...
							<li>
								<a href="list4.html"><img src="{{Theme::asset()->url('images/thumb-santorini.jpg')}}" alt=""/></a>
								<div class="m1">
							...
							<li>
								<a href="list4.html"><img src="{{Theme::asset()->url('images/thumb-dubai.jpg')}}" alt=""/></a>
								<div class="m1">
						...
						<div class="clearfix"></div>
						<a id="prev_btn" class="prev" href="#"><img src="{{Theme::asset()->url('images/spacer.png')}}" alt=""/></a>
						<a id="next_btn" class="next" href="#"><img src="{{Theme::asset()->url('images/spacer.png')}}" alt=""/></a>
					</div>
				</div>
			  ...
			  <div class="col-md-9">
				...
				<div class="wrapper">
					<div class="list_carousel">		
						<ul id="foo2">
							<li>
								<a href="list4.html"><img src="images/thumb-africa.jpg" alt=""/></a>
								<div class="m1">
							...
							<li>
								<a href="list4.html"><img src="images/thumb-egipt.jpg" alt=""/></a>
								<div class="m1">
							...
							<li>
								<a href="list4.html"><img src="images/thumb-machupicchu.jpg" alt=""/></a>
								<div class="m1">
