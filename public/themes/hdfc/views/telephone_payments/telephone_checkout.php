					...
					<div class="hpadding30 margtop30">
						<table class="table table-bordered margbottom20">
							...
							<tr>
								...
								<td class="center green bold"><?php echo $post['telephone_name']; ?></td>
							</tr>
							<tr>
								<td>Service Number</td>
								<td class="center green bold"><?php echo $post['telephone_no']; ?></td>
							</tr>
							<tr>
								<td>Customer Name</td>
								<td class="center green bold"><?php echo $post['customer_name']; ?></td>
							</tr>
							<tr>
