				...
				<div class="pagecontainer2 paymentbox grey">
					...
					<div class="hpadding30 margtop30">
						<table class="table table-bordered margbottom20">
                                              <?php 
                                     $payeeing_for = DB::table('billers')->select('biller_name')->where('id',$dth_name)->first();
                                              ?>
							<tr>
								<td>DTH Name</td>
							...
							<tr>
								<td>DTH Subscriber ID</td>
								<td class="center green bold"><?php echo $subscriber_id;?></td>
							</tr>
							<tr>
								<td> Subscriber Name</td>
								<td class="center green bold"><?php echo $subscriber_name;?></td>
							</tr>
							<tr>
								<td> Amount</td>
