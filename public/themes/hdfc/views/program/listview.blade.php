...
<button class="grid2btn" onClick="window.open('gridview','_self');">&nbsp;</button>
				...
				<div class="itemscontainer offset-1">
					...
					<div class="offset-2">
						<div class="col-md-4 offset-0">
							<div class="listitem2">
								<img src="<?php print_r(Config::get('app.url').'uploads/program_images/'.$program->image);?>" alt=""/>
						...
						<div class="col-md-8 offset-0">
							<div class="itemlabel3">
								<div class="labelright">
									...
									<span class="detail"><a><?php echo HTML::decode(HTML::link('program_details/'.$program->id, ''.'Details', array('class' => 'bookbtn mt1')));?></a></span>				
								</div>
								<div class="labelleft2">			
									<b><?php echo $program->pgm_name; ?></b><br/><br/><br/>
									<p class="grey">
									<?php echo $program->pgm_desc; ?>.</p><br/>
