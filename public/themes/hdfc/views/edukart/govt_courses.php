...
<h2><font color="blue">Government Certified Course</font></h2><?php foreach($coursename as $name) { 
               	 echo $name['name'];
		} ?>
</div>
...
<div id="total" style="margin-right: 57px;margin-top: 8px;">Total Fee: Rs. <?php echo $fee; ?></div>
     ...
     <?php foreach($gvt_details as $details){   ?>
         <h4>Brief</h4>
        <div><p><?php echo $details['Brief']; ?></p>
              </div>
     <h4>About_the_Course</h4>
        <div><p><?php echo $details['About_the_Course']; ?></p>
              </div>
<h4>About_Certification</h4>
        <div><p><?php echo $details['About_Certification']; ?></p>
              </div>
<h4>How_does_it_work</h4>
        <div><p><?php echo $details['How_does_it_work']; ?></p>
              </div>
<h4>Features</h4>
