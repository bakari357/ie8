...
<input type="hidden" name="return" value="<?php if(isset($_POST['return'])) echo  $_POST['return']; ?>" />						<!-- HOTELS TAB -->
...
<div class="rightcontent col-md-9 offset-0">
	...
	<form id="flightform" accept-charset="UTF-8" name="flightform" method="POST" action="<?php echo $url = URL::action('Goibibo@go_Checkout'); ?>">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
	 <section class="proceed_sec">
		    ...
		    <div class="fare_price_list_header">
                ...
                <input type="radio" name="proceed_prices" id="proceed_go" value="flightform" /><div class="fare_pad1" style="
    padding-left: 20px;
"></div>
                <br>
                <input type="radio" name="proceed_prices" id="proceed_clear" value="clearform" /><div class="cleartrip_pad" style="
    padding-left: 20px;
"></div>
                </div>
                </td><td valign="bottom">
	...
	<form id="clearform" name="clearform" accept-charset="UTF-8" method="POST" action="<?php echo $url = URL::action('Goibibo@clear_Checkout'); ?>">	<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
...
<input type="hidden" naame="discouted" value="N" / >
<input type="hidden" name="goingto"  id="goingto" value="<?php if(isset($_POST['goingto'])) echo trim($_POST['goingto']) ; ?>" />
<input type="hidden" name="goingto1"  id="goingto2" value="<?php if(isset($_POST['goingto1'])) echo trim($_POST['goingto1']) ; ?>" />
<?php $p= str_replace('"','quot',serialize($post)) ;?>
