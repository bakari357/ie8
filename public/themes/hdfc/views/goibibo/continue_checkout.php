						...
						<div class="col-md-3">
							<div class="w100percent">
								...
								<?php 
                                                                ...
                                                                {
                                                                echo $_POST['passport_number'.$i] ;  ?>
                                                            <input type="hidden" name="passport_number<?php echo $i;?>" id="passport_number<?php echo $i;?>" class="form-control " placeholder="" value="<?php echo $_POST['passport_number'.$i] ; ?>">
                                                                <?php } ?>
...
<div class="col-md-10 textright"><br>
					...
					<div class="col-md-4">
						...
						&nbsp;&nbsp;<?php echo $_POST['country']; ?><input type="hidden" name="country" id="firstName"class="form-control " placeholder="" value="<?php echo $_POST['country']; ?>">
					</div>
					<div class="col-md-4 textleft">
					<span class="dark">State:</span>
						&nbsp;&nbsp;<?php echo $_POST['state']; ?><input type="hidden" name="state" id="state" class="form-control " placeholder="" value="<?php echo $_POST['state']; ?>">
					</div>
                                        
                                        <div class="clearfix"></div><br/>
                                        <div class="col-md-4">
						<span class="dark">City:</span>
						&nbsp;&nbsp;<?php echo $_POST['city']; ?><input type="hidden" name="city" id="firstName"class="form-control " placeholder="" value="<?php echo $_POST['city']; ?>">
					</div>
					<div class="col-md-4 textleft">
					<span class="dark">Pincode:</span>
						&nbsp;&nbsp;<?php echo $_POST['pincode']; ?><input type="hidden" name="pincode" id="lastName" class="form-control " placeholder="" value="<?php echo $_POST['pincode']; ?>">
					</div>
                                        
                                        <div class="clearfix"></div><br/>
                                        <div class="col-md-4">
						<span class="dark">Address:</span>
						&nbsp;&nbsp;<?php echo $_POST['address']; ?><input type="hidden" name="address" id="firstName"class="form-control " placeholder="" value="<?php echo $_POST['address']; ?>">
					</div>
					<div class="col-md-4 textleft">
					...
					if(isset($clear_select) && $clear_select<>'')
                                        ...
                                        'book'=>'trip',	
                                        'cash'=>0,
                                        'ctype'=>'goibibo_flights',
                                        'emi_data'=>$emi_data,
                                        'interest'=>$interest,
                                        'display_term'=>'2',
                                        'form_option'=>0,
                                        'msg'=>Lang::get('partners.goibibo.checkout')
                                        );
                                        }
			...
			<div class="col-md-4" >
				...
				<div class="pagecontainer2 paymentbox grey">
					...
					<div class="line3"></div>
					<div class="padding20">					
						<span class="left size14 " style="font-weight:normal;">Booking Total  <br/> </span>
						...
						<span class="right" style="text-align: right;font-weight:normal;"  >₹ 
                                        ...
                                        if(!empty($offer)){ ?>
                                        <div class="padding20">	
					<span class="left size14 "style="font-weight:normal;">Code Applied</span>

                                        <span class="right " style="color:#e20613;font-weight:normal;"> <?php echo $coupon_code; ?> </span>			
					</div>	
				 <div class="padding20">		
                                        <span class="left size14 "style="font-weight:normal;">SmartBuy Exclusive Offer:</span>

                                        <span class="right " style="color:#e20613;font-weight:normal;"> ₹ <?php echo $offer['discount_amount'];?> </span>

                                        </div>
                                        <div class="padding20" >					
					<span class="left size14 "style="font-weight:normal;">Net Payable Amount:</span>
	
<span class="right" style="text-align: right;font-weight:normal;">₹ <?php echo round($amount - $offer['discount_amount'] );?> </span>
					...
					<div class="padding20">
                                        ...
                                        {  
                                        ?>
                                        <a href="javascript:;" onclick="funform1('<?php echo $itinerary_id ;?>');" class="time_button tt3"  >Fare Rules
                                        </a>
                                        <?php }
                                        else
                                        {
