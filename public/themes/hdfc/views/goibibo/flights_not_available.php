	    ...
	    <div>
			...
			<div class="left">
				<ul class="bcrumbs">
					...
					<li><a href="<?php  print_r(Config::get('app.url')); ?>" class="active">Home</a></li>					
				</ul>				
			</div>
...
<ul id="menu_foo1">
    ...
    <div style="margin:100px 0 0 150px;"> <strong>Flight you are trying to book is either full or unavailable. Please try again with some other flight. </strong> 
    <br/>
    <?php echo HTML::link('flight_index', 'Click Here'); ?>
    </div>
