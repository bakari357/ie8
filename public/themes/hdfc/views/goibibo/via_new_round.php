	...
	<form id="flightform" name="flightform" accept-charset="UTF-8" method="POST" action="<?php echo $url = URL::action('Goibibo@go_Checkout'); ?>">
	 ...
	 <section class="proceed_sec">
			...
			Searching for Fares
                ...
                <input type="radio" name="proceed_prices" id="proceed_go" value="flightform" />
<div class="fare_pad1" style="padding-left: 20px;"></div>
                <br>
                <input type="radio" name="proceed_prices" id="proceed_clear" value="clearform" />
<div class="cleartrip_pad" style="padding-left: 20px;"></div>
                </div>
                </td><td valign="bottom">
