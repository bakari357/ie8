				...
				<div class="pagecontainer2 paymentbox grey">
					...
					<div class="hpadding30 margtop30">
						<table class="table table-bordered margbottom20">
                                              <?php 
                                     $payeeing_for = DB::table('billers')->select('biller_name')->where('id',$biller_id)->first();
                                              ?>
							<tr>
								<td>Paying for</td>
							...
							<tr>
								<td>Contribution Scheme</td>
								<td class="center green bold"><?php echo $contribution_scheme;?></td>
							</tr>
							<tr>
								<td>Amount</td>
