...
<script src="themes/hdfc/assets/js/jquery-ui-1.10.3.custom.js"></script>
<script src="themes/hdfc/assets/js/jquery.lazyload.js"></script> 
...
<script>
	...
	$.validator.addMethod("falpha", function(value, element) {
            ...
            },  "Flying from contain only letters");
        
        $.validator.addMethod("falphda", function(value, element) {
                return this.optional(element) || /^[a-z\-\s]+$/i.test(value);
            },  "Flying To contain only letters");
            
	$('#flights_data').validate({
	                focusInvalid: false,
	                ignore: "",
	                rules: {
	                       leavingfrom1: {
	        ...
	        var leave=$('#leavingfrom1').val();
                
                
                var go =$('#goingto1').val();

                if(leave==null || leave=="" && go==null || go=="")
                {  
...
<!-- /Top wrapper -->
	...
	<div class="wrap cstyle03">
		<form name="complaintdetails" method="post" id="flights_data">
			...
			<div class="col-md-12">
				<div class="bs-example bs-example-tabs cstyle04">
					...
					<ul class="nav nav-tabs" id="myTab">
						<li onclick="mySelectUpdate()" class="active"><?php echo HTML::link('flight_index', 'Domestic Flight'); ?></li>
						<li onclick="mySelectUpdate()"><?php echo HTML::link('flight_int', 'International Flight'); ?></li>
