...
<!--						<span class="size12">First and Last Name<font color="red">*</font></span>-->
						<input type="hidden" class="form-control " name="name" value="<?php echo $post['name'];?>" id="name" placeholder="">
                                                <?php echo $post['name'];?>
					</div>
...
<!--						<span class="size12">Preferred Phone Number<font color="red">*</font></span>	-->
						<input type="hidden" class="form-control" placeholder="" name="phonenumber" id="phonenumber" value="<?php echo $post['phonenumber'];?>">
                                                <?php echo $post['phonenumber'];?>
					</div>
					<div class="clearfix"></div>
...
<!--						<span class="size12">Email Address<font color="red">*</font></span>	-->
						<input type="hidden" value="<?php echo $post['s_email'];?>" class="form-control margtop10" placeholder="" name="email" id="email">
