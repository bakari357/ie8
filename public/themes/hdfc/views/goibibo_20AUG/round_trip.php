...
<div class="flightstab2">
							...
							<span class="going-to" style="margin-top:62px;margin-left:-133px"><b>Flying To</b></span>
									<input type="text" name="goingto1"  class="flights-new-control-going-to" style="margin-left:-127px" id="goingto"  value="<?php if(isset($_POST['goingto1'])) echo trim($_POST['goingto1']) ; ?>"/>
								</div>
							</div>
...
</a> <span class="refund_txt get_fare">{{rf}}</span>{{/show_price}}</td>
...
<span class="tooltip">
 ...
 </a> <span class="refund_txt get_fare">Refundable</span>{{/show_price}}</td>
<td class="select_fly">
{{#flightservice}}     
<div class="disp_trip">
<div class="abimg"><img src="themes/hdfc/assets/images/via/{{img}}" align="absmiddle"></div>
