      ...
      <div class="col-md-12">
        <div class="bs-example bs-example-tabs cstyle04">
          <ul class="nav nav-tabs" id="myTab" style="background: none !important; margin-top: -96px;">
            ...
            <li onclick="mySelectUpdate()"  style="background: #fff !important;"><a style="color: #004387 !important;">Domestic Flights</a></li>
            <li onclick="mySelectUpdate()" class="inactive" ><?php echo HTML::link('flight_int', 'International Flights'); ?></li>
          </ul>
          <div class="tab-content3" id="myTabContent">
            ...
            <div class="tab-pane fade active in">
              <div class="col-md-12">
                <input type="radio" name="type"   <?php if(isset($_POST['type']) && $_POST['type']=='O') echo 'checked'; else echo 'checked'; ?>  value="O"  onclick="changetype()"/>
                <span class=""style="margin-right: 30px;margin-left:12px">One-way</span>
                <input type="radio" name="type" style="margin-left:12px"<?php if(isset($_POST['type']) && $_POST['type']=='R') echo 'checked';  ?>  value="R" onclick="changetype()"  />
                <span style="margin-left:12px"> Round trip</span></div>
 </br>
              <div class="col-md-3">
                <div class="w90percent">
                  <div class="wh90percent textleft"> <span class="opensans size13"><b>Flying from</b></span>
                ...
                <div class="w90percent">
                  <div class="wh90percent textleft"> <span class="opensans size13"><b>To</b></span>
              ...
              <div class="col-md-2" style="margin-left: -40px;">
                <div class="w90percent">
                  <div class="wh90percent textleft"> <span class="opensans size13"><b>Departing</b></span>
                ...
                <div class="w90percent">
                  <div class="wh90percent textleft"> <span class="opensans size13"><b>Returning</b></span>
              ...
              <div class="col-md-1" style="margin-left: -14px;">
                <div class="w90percent">
                  <div class="wh90percent textleft"> <span class="opensans size13"><b>Adult</b></span>
              ...
              <div class="col-md-1">
                <div class="w90percentlast">
                  <div class="wh90percent textleft "> <span class="opensans size13"><b>Child</b></span>
              ...
              <div class="col-md-1">
                <div class="w90percent textleft "> <span class="opensans size13"><b>Infants</b></span>
              ...
              <div class="col-md-12">
                <div class="col-md-2 pull-right no_pright">
                  <div class="w100percent textleft "> <span class="opensans size13"><b>Class</b></span>
          ...
          <div class="searchbg4">
            <button type="submit" onclick="return compare();" class="btn-search right mr30">Search</button>
          </div>
        </div>
      </div>
    </div>
