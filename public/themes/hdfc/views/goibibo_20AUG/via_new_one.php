...
<!-- Price range -->					
				<button type="button" class="collapsebtn" data-toggle="collapse" data-target="#collapse2">
				  Price <span style="margin-top: 26px;display: inline-block;"></span>
				</button>
...
<table cellpadding="0" cellspacing="0" class="flights_table_one">
		...
		<th colspan="9" class="headtxt"><?php echo $_POST['leavingfrom1'] ?>&nbsp; <img src="<?php print_r(Config::get('app.url'))?>themes/hdfc/assets/images/blue_arrow.jpg">&nbsp; <?php echo $_POST['goingto1'];?> - <?php $tomorrow = mktime(0, 0, 0, date("m"), date("d")+1, date("y")); ?><?php if(isset($_POST['departure'])) echo date('j F Y', strtotime($_POST['departure'] )); else echo date('j F Y',$tomorrow);?> </th>      
			...
			<th width="15%">Duration</th>
                        ...
                        <th width="18%" style=" padding-left: 24px;">Price</th>
		</tr>	
</table>
...
{{#fcnt}}
			...
			<td width="15%"><span class="space">{{duration}}<br>{{nos}} - stop</td>
...
<p>{{duration}} | {{sour}}<img class="garrow" src="<?php print_r(Config::get('app.url'))?>themes/hdfc/assets/images/blue_arrow.jpg">{{desti}}</p>
</div>
{{/onwardfl}}
...
<div id="result" align="center"><div style="padding-top:120px;">  
               	<section class="retrive_password">
                    ...
                    <img style="padding-right: 57px;" src="<?php print_r(Config::get('app.url'))?>themes/hdfc/assets/images/ajax-loader.gif"> </div>
