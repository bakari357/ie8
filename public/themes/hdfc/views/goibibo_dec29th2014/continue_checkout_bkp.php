			...
			<div class="col-md-8 pagecontainer2 offset-0">
				...
				<div class="padding30 grey">
					...
					<div class="col-md-4">
						...
						<input type="hidden" class="form-control " name="name" value="<?php echo $_POST['name'];?>" id="name" placeholder="">
                                                <?php echo $_POST['name'];?>
					</div>
					...
					<div class="col-md-4 textleft">
						...
						<input type="hidden" class="form-control" placeholder="" name="phonenumber" id="phonenumber" value="<?php echo $_POST['phonenumber'];?>">
					...
					<div class="col-md-4">
						<input type="hidden" value="<?php echo $_POST['s_email'];?>" class="form-control margtop10" placeholder="" name="s_email" id="email">
                                                <?php echo $_POST['s_email'];?><br/><br/>
					</div>
					<div class="col-md-4 textleft">
					</div>
					<div class="clearfix"></div>
                                        <input type="hidden" name="ctype" value="Cleartrip_flights"/>
                                        <input type="hidden" name="patner" value="Cleartrip_flights"/>
