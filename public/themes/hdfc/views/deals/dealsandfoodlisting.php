		...
		<div class="container pagecontainer offset-0" >	
			...
			<div class=" col-md-12 offset-0">
				...
				<div class="hpadding20">
					<!-- Top filters -->
<form method="POST" action="dealsandfiesta" id="deals_form" name="deals_form" accept-charset="UTF-8">	
...
<?php $i=0; } ?>
 ...
 ?>
                                             <div class="cpadding01"> 
                                                 <?php echo '<font color="#034387" style="font-size:13px;"><b>'.$deal_or_food_name.'</b></br></font><span style="font-size:12px; color:#cc0000" ><b>'.$offer_name.'</b></span><span style="font-size:11px;">' ?>.<br/>Address : <?php echo  $deals->address; ?></span></div>   
                                            </li>
...
<div class="clearfix"></div>
	<div style="float:right; margin-top:20px"><?php  echo $offers->appends(array("city"=>$selected_city,"area"=>$selected_area,"category"=>$selected_categeory))->links(); ?> </div>
<div class="clearfix"></div>
 <br><br>
