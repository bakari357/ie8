...
<div class="clearfix"></div> 
					...
					<br/>
					<br/>
					<span class="size16px bold dark left">Review and pay your bill</span>
				...
				<div class="pagecontainer2 paymentbox grey">
					...
					<div class="hpadding30 margtop30">
						<table class="table table-bordered margbottom20">
							...
							<tr>
								<td>Gas  Name</td>
								<td class="center green bold"><?php echo $post['gas_name']; ?></td>
							</tr>
							<tr>
								<td>Service Number</td>
								<td class="center green bold"><?php echo $post['consumer_no']; ?></td>
							</tr>
							<tr>
