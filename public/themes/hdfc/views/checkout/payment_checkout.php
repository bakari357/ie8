...
case 'recharge': 
if($_POST['ttype'] =="etop"){?>
<form method="post" action="<?php echo $url = URL::action('MobilePayment@prepaid_payment_final'); ?>" id="checkout_form"  name="checkout_form" >
<?php } else { ?>
<form method="post" action="<?php echo $url = URL::action('MobilePayment@postpaid_payment_final'); ?>" id="checkout_form"  name="checkout_form" >
<?php }
break; case 'DTH':?>
 
<form method="post" action="<?php echo $url = URL::action('DthPayment@do_payment_final'); ?>" id="checkout_form"  name="checkout_form" >
<?php  break; case 'electricity': ?>
<form method="post" action="<?php echo $url = URL::action('ElectricityPayment@eb_payment_final'); ?>" id="checkout_form"  name="checkout_form" >
<?php  break; case 'gas':  ?>
<form method="post" action="<?php echo $url = URL::action('GasPayment@gas_payment_final'); ?>" id="checkout_form"  name="checkout_form" >
...
<form method="post" action="<?php echo $url = URL::action('CharityPayment@charity_payment_final'); ?>" id="checkout_form"  name="checkout_form" >


<?php break; case 'creditcard': ?>
<form method="post" action="<?php echo $url = URL::action('Creditcard@crditcard_payment_final'); ?>" id="checkout_form"  name="checkout_form" >

<?php break;  case 'insurance':?> 
<form method="post" action="<?php echo $url = URL::action('InsurancePayment@insurance_payment_final'); ?>" id="checkout_form"  name="checkout_form" >
...
$view = View::make('checkout/common',$data);	echo $view;	?>
<br/>
<br/>
<?php
$type = $post['payment']; 
...
<input type="hidden" value="<?php echo $_POST['po_circle'];?>" name="po_circle" />
<input type="hidden" value="<?php echo $_POST['po_operator'];?>" name="po_operator" />
...
<td><?php echo $post['po_payee_presence']; ?></td>
</tr>
<tr>
...
<tr>
<td colspan=2><span class="dark">DTH Subscriber ID</span></td>
...
case 'recharge':	
  if($post['flag'] =="2") { ?>	
<!--<span class="right lred2 bold size18">₹ <?php echo $post['po_amount'];?> </span>!-->
<?php } else {?>
<!--<span class="right lred2 bold size18">₹ <?php echo $post['amount'];?> </span>!-->
<?php }break; default: ?>
<!--<span class="right lred2 bold size18">₹ <?php echo $post['amount'];?> </span>!-->
<?php }?>	
<div class="clearfix"></div>
