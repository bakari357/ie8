...
<form action="<?php echo $url = URL::action('Cleartrip@Listing_Flights'); ?>" accept-charset="UTF-8"  name="complaintdetails" method="post" id="complaintregisterpage">
      ...
      <div class="col-md-12">
        <div class="bs-example bs-example-tabs cstyle04">
          <ul class="nav nav-tabs" id="myTab" style="background: none !important; margin-top: -96px;">
            ...
            <li onclick="mySelectUpdate()" class="inactive col-xs-6 col-md-3 col-lg-3" ><?php echo HTML::link('clear_int', 'International Flights'); ?></li>
          </ul>
