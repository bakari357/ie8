...
var onward_date='<?php echo  $_POST['departure'];?>';
var return_date='<?php echo  $_POST['return'];?>';
...
<script src="themes/hdfc/assets/js/cleartrip/filter_criti.js"></script>
<script src="themes/hdfc/assets/js/cleartrip/round_criti.js"></script>    
<script src="themes/hdfc/assets/js/cleartrip/fare_round.js"></script>			
		...
		<div class="container pagecontainer offset-0">	
			...
			<div class="col-md-3 filters offset-0">
				...
				<div class="bookfilters hpadding20">
						...
						<form name="complaintdetails" accept-charset="UTF-8" method="post" id="singleform" class="form-horizontal" action="">
...
<input type="hidden" name="return" value="<?php if(isset($_POST['return'])) echo  $_POST['return']; ?>" />
...
<div class="flightstab2">
							...
							<div class="w50percent">
								<div class="wh95percent textleft">
 ...
 <?php $tomorrow = date('m/d/Y',mktime(0, 0, 0, date("m"), date("d")+1, date("y"))); ?>
								...
								<div class="w50percent">
								<div class="wh95percent textleft right">
								...
								<div class="clearfix pbottom15" ></div>
									...
									<div class="wh100percent">
										<span class="opensans size13 "><b>Class</b></span>
                                                                        <select id="cabinClass" class="form-control_flights form-control" name="class">
...
<div class="rightcontent col-md-9 offset-0">
	...
	<form id="clearform" accept-charset="UTF-8" name="flightform" method="POST" action="checkout_cleartrip">
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
	...
	<input type="hidden" id="clearpost" name="clearpost" value="<?php echo $p; ?>">
	 ...
	 <section class="proceed_sec">
			...
			Searching for Fares
			<img src="themes/hdfc/assets/images/ajax-loader.gif">
			</section>
		    ...
		    <div class="fare_price_list_header">
                ...
                <div style="width: 200px;padding-left:10px">
                 <input type="radio" name="proceed_prices" id="proceed_clear" value="clearform" />
                <section class="fare_pad1"></section>
                <br>
               
                   
                     <input type="radio" name="proceed_prices" id="proceed_go" value="flightform" /><section class="cleartrip_pad" >    
                <section class="cleartrip_pad"></section>
                </div>
                </td><td valign="bottom">
	...
	<form id="flightform" name="clearform" accept-charset="UTF-8" method="POST" action="checkout_goibibo">	
            <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
	 <?php $p= str_replace('"','quot',serialize($post)) ;?>
<input type="hidden" name="post" value="<?php echo $p ?>" />
<input type="hidden" id="goibibo_data" name="fuldata" value="">
<input type="hidden" id="return_data" name="returndata" value="" />	
	</form>
<div id="hidef">		
...
<td class="chn_points" style="background:none; padding:4px 0; border:none; color:#0062b6; font-size:12px;font-family:'Helvetica', Arial, sans-serif; outline:none;">{{#show_price}}<a class="btn_price tt">&#8377; {{#price}}{{cash}}{{/price}} 
                        <span class="tooltip1">
                              ...
                              {{/flightservice}}
                               ...
                               </a> <span class="refund_txt get_fare" style="margin-left:25px;">{{#price}}{{rf}}{{/price}}</span>{{/show_price}}</td>
...
<input type="hidden" name="clear_select" class="clear_select" value={{flightdata_onward}} />
<!--pricing -->
...
<td class=select_refund style="display: none;">{{#price}}{{rf}}{{/price}}</td>
<td class=sour style="display: none;">{{sour}}</td>
<td class=desti style="display: none;">{{desti}}</td>
<td class=arr_tym style="display: none;">{{arr_tym}}</td>
<td class=dst_tym style="display: none;">{{dst_tym}}</td>
...
</a> <span class="refund_txt get_fare" style="margin-left:25px;" onclick="get_fare('{{sour}},{{desti}},{{car_id}},{{fclass}},{{fbasis}}')">{{#price}}{{rf}}{{/price}}</span>{{/show_price}}</td>
<td class="select_fly">
{{#flightservice}}     
<div class="disp_trip">
<div class="abimg"><img src="themes/hdfc/assets/images/via/{{img}}" align="absmiddle"></div>
...
<td class="chn_points">{{#show_price}}<a class="btn_price tt">&#8377; {{#price}}{{cash}}{{/price}}
					...
					{{#flightservice}}{{#fcnt}}
                                        <section class="fare_txt">Fare type:<section class="refund_color">{{#price}}{{rf}}{{/price}}</section>s
				      </section>{{/fcnt}}{{/flightservice}}
                                    </span>
                                    <span class="bottom">
				{{#flightservice}}
...
<input type="hidden" name="return_select" class="return_select" value={{flightdata_return}} />
<!--pricing -->
...
<td class=select_fcode style="display: none;">{{#flightservice}}{{fnum}},{{/flightservice}}</td>
<td class=select_refund style="display: none;">{{#price}}{{rf}}{{/price}}</td>
<td class=return_sour style="display: none;">{{arr_tym}}</td>
<td class=return_desti style="display: none;">{{dest_tym}}</td>
<td class=arr_tym style="display: none;">{{arr_tym}}</td>
<td class=dst_tym style="display: none;">{{dst_tym}}</td>
</tr>
			{{/fcnt}}
...
//		$(".fare_loader").hide();
//		$(".fare_pad1").html('<img src="themes/hdfc/assets/images/cleartrip.png" height="17px">  &#8377 '+combined_price);
//		$("#proceed").show();
//
//		
...
//		$(".fare_loader").hide();
//		$(".fare_pad").html('<img src="themes/hdfc/assets/images/goibibo.png" height="17px">  &#8377 '+combined_price);
//	
//		
//		
//		if((return_total != "" && onward_total != "")  || (typeof return_total != "undefined" &&  typeof onward_total != "undefined"))
//		{
//                    
////		console.log(onward_total);console.log(return_total);
//		var clear_total=onward_total+return_total;
//		
//		$(".cleartrip_pad").html('<img src="themes/hdfc/assets/images/cleartrip-logo1.png" height="21px"> &#8377 '+clear_total);
//		var fares = [combined_price,clear_total];
