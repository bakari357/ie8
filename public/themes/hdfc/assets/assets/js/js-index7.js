...
"use strict";
  ...
  jQuery(".scrolleffect").css({'top': ((- jQueryscrollTop / 5)+ jQueryheaderheight) + 0  + 'px' });
...
"use strict";	
		...
		if(jQuery(window).scrollTop() != 0){
			...
			jQuery('.logo').stop().animate({width: '109px'}, 100);
			...
			jQuery('.logo').stop().animate({width: '179px'}, 100);		
