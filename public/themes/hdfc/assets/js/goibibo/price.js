...
(function(window) {
  ...
  var PriceJS = function(data, container, view,options) {
    return new _PriceJS(data, container, view, options);
  };

  PriceJS.VERSION = '1.5.1';

  $.fn.PriceJS = function(data, view, options) {
    var $this = $(this);
    if ($this.data('fjs')) return;
    $this.data('fjs', new _PriceJS(data, $this, view, options));
  };

  window.PriceJS = PriceJS;

  var _PriceJS = function(data, container, view, options) {
