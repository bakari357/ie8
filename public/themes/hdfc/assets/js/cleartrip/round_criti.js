...
//                                flight.farekey.push(fk);
			...
			flight.price.push(ps);
                        ...
                        clear_sky.clear_select=new Array();
                        flight.flightdata_onward=new Array();
                        
                        flight.flightdata_onward.push(encodeURI(JSON.stringify(flight)));
...
/*-----------price info ends here---------------------*/
                        ...
                        clear_sky.return_select=new Array();
                        flight.flightdata_return=new Array();
                        
                        flight.flightdata_return.push(encodeURI(JSON.stringify(flight)));
				var county= new Object();
				if(cnt==1)
				flight.row=cnt;
				else
...
$('.fare_button').hide();
      ...
      var goibibo=get_checked_cleartrip();
