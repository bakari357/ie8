...
//			clear_sky.push(flight);
                       ...
                       // $("#clear_select").val(JSON.stringify(clear_sky));
/*-----------price info ends here---------------------*/
                        clear_sky.clear_select=new Array();
                        flight.flightdata=new Array();
                        
                        flight.flightdata.push(encodeURI(JSON.stringify(flight)));
			//full_sky.push(flight);
                       // clear_select=[];
                       //clear_sky.clear_select.push(JSON.stringify(flight));
                       //console.log(flight);
