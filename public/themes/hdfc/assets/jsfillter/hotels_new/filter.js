...
(function(window) {
  ...
  var FilterJS = function(data,services, container, view, options) {
    return new _FilterJS(data,services, container, view, options);
  };
  ...
  $.fn.filterjs = function(data,services, view, options) {
    var $this = $(this);
    if ($this.data('fjs')) return;
    $this.data('fjs', new _FilterJS(data,services, $this, view, options));
  };

  window.FilterJS = FilterJS;

  var _FilterJS = function(data,services, container, view, options) {
...
//console.log(this.services);
 ...
 //console.log((this.services.length-25));
     //console.log(this.data.length);

      if(this.data.length < (this.services.length)){
	this.hotel_data= this.services.slice(this.options.streaming.batch_size,  params['offset']+this.options.streaming.batch_size);
	self.addData(this.hotel_data);
...
/**
 * Recursive method to collerct object from json object.
