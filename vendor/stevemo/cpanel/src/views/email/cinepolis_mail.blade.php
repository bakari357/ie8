...
<div style="float:left; background-color:#f7f7f7; width:600; font-family:Arial, Helvetica, sans-serif; font-size:12px; padding:20px 13px 20px 13px; margin:0px auto; color:#333333;">
    <table cellpadding="0" cellspacing="0" border="0" align="center" width="600">
        <tr>
            <td><a href="#" style="text-decoration:none;"><img src="http://202.140.38.73/smartbuy/public/themes/hdfc/assets/images/smartbuy-logo.jpg" width="180" height="50" border="0" /></a></a></td>
            <td style="text-align:right;"><a href="#" style="text-decoration:none; color:#004c8f; font-family:Arial, Helvetica, sans-serif; font-size:14px;"><img src="http://202.140.38.73/smartbuy/public/themes/hdfc/assets/images/hdfc-logo.jpg" width="88" height="31" border="0" /></a></td>
        </tr>
        ...
        <tr>
        	<td colspan="2" style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333; width:674px; border:2px solid #f3f3f3; background-color:#ffffff; margin:0px 0px 0px 0px;">
            	<table cellpadding="0" cellspacing="0" border="0" align="center" style="width:634px;">
            		<tr>
            		 <?php if(isset($code['order_details']['status']) && $code['order_details']['status'] =='Successful') {  ?>
            		   <td colspan="2" style="border-bottom:1px dotted #333333; padding:20px 0px 15px 0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:18px; color:#333333;">Dear <?php echo ucfirst($code['customer']['first_name']); ?>,<br /><br />Congratulations on the Successful Movie transaction against your Axis Edge.<br />Please find below your Transaction details. </td>
            		    <?php } elseif(isset($code['order_details']['status']) && $code['order_details']['status'] =='Declined') {  ?>
            		    <td colspan="2" style="border-bottom:1px dotted #333333; padding:20px 0px 15px 0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:18px; color:#333333;">Dear <?php echo ucfirst($code['order_details']['firstname']); ?>,<br /><br />Sorry! Your order has Failed.<br />Please find below your Transaction details. </td>
            		  <?php }
            		  
            		  elseif(isset($code['order_details']['status']) && $code['order_details']['status'] =='Pending') {  ?>
            		    <td colspan="2" style="border-bottom:1px dotted #333333; padding:20px 0px 15px 0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:18px; color:#333333;">Dear <?php echo ucfirst($code['order_details']['firstname']); ?>,<br /><br />Your Transaction is pending<br />Please find below your Transaction details. </td>
            		  <?php } else { ?>
              		  <td colspan="2" style="border-bottom:1px dotted #333333; padding:20px 0px 15px 0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:18px; color:#333333;">Dear <?php echo ucfirst($code['order_details']['firstname']); ?>,<br /><br />Sorry! Your order has Failed. The deducted amount will be refunded back to your account in the next 15 business days.<br />Please find below your Movie details. </td>
              		 <?php } ?>  
            		</tr>
                    <tr>
                    	<td colspan="2" style="border-bottom:1px dotted #333333; padding:15px 0px 15px 0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;">
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
                                <tr>
                                    ...
                                    <td width="25%" style="color:#333333; font-size:12px; font-family:Arial, Helvetica, sans-serif; padding:0px; margin:0px;"><?php echo $code['order_details']['order_number']; ?></td>
                                </tr>
                                <tr>
                               		<td></td>
                                    <td></td>
                                ...
                                <tr>
                                	...
                                	<?php if(isset($code['order_details']['status']) && $code['order_details']['status'] =='Declined')
                                	{ ?>
                                    ...
                                    <?php } elseif(isset($code['order_details']['status']) && $code['order_details']['status'] == 'Pending') { ?> 
                                   ...
                                   <?php } elseif(isset($code['order_details']['status']) && $code['order_details']['status'] !='Successful') { ?> 
                    	...
                    	<td colspan="2" style="border-bottom:1px dotted #333333; padding:0px 0px 15px 0px; font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#333333;">
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
                            	<tr><?php $details = $code['input']['Posted']; ?>
                                    ...
                                    <td style="color:#808080; width:110px; font-size:11px; font-family:Arial, Helvetica, sans-serif; padding:0px; margin:0px;"><?php echo $details['moviename']; ?></td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="color:#808080; width:110px; font-size:11px; font-family:Arial, Helvetica, sans-serif; padding:0px; margin:0px;"><?php echo  $code['input']['Center']; ?></td>
                                </tr>
                                 <tr>
                                	<td style="color:#808080; width:115px; font-size:11px; font-family:Arial, Helvetica, sans-serif; padding:0px; margin:0px;">Class</td>
                                    <td style="color:#808080; width:110px; font-size:11px; font-family:Arial, Helvetica, sans-serif; padding:0px; margin:0px;"><?php echo $code['input']['class']; ?></td>
                                </tr>
                                <tr>
