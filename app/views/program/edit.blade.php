...
<div class="row">
    <div class="col-lg-12">
        <?php
        $option = array(
            'route' => array('cpanel.program.update',$program->id),
            'method' => 'put',
            'files' => true,
            'class' => 'form-horizontal'
        );
        ?>
        {{ Form::model($program,$option) }}
       
       
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Edit Program  &quot;{{ @$program->pgm_name }}&quot;</h3>
                             </div>
                     ...
                     <div class="tab-pane" id="images">
                               ...
                               <h3>  <li class="active">Customer Attributes</li></h3>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        {{ Form::checkbox('first_name', '1',@$program_details->first_name) }}
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-sm-2 control-label" for="title">Last Name</label>
                                    <div class="col-md-4">
                                        {{ Form::checkbox('last_name', '1',@$program_details->last_name) }}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label" for="title">Date of Birth</label>
                                    <div class="col-md-4">
                                        {{ Form::checkbox('dob', '1',@$program_details->dob) }}
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        {{ Form::checkbox('address1', '1',@$program_details->address1) }}
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-sm-2 control-label" for="title">Address 2</label>
                                    <div class="col-md-4">
                                        {{ Form::checkbox('address2', '1',@$program_details->address2) }}
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-sm-2 control-label" for="title">City</label>
                                    <div class="col-md-4">
                                        {{ Form::checkbox('city', '1',@$program_details->city) }}
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        {{ Form::checkbox('state', '1',@$program_details->state) }}
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-sm-2 control-label" for="title">Pincode</label>
                                    <div class="col-md-4">
                                        {{ Form::checkbox('pincode', '1',@$program_details->pincode) }}
                                    </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-sm-2 control-label" for="title">Country</label>
                                    <div class="col-md-4">
                                        {{ Form::checkbox('country', '1',@$program_details->country) }}
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        {{ Form::textarea('maker_comment',@$program_details->maker_comment,array('class'=>'form-control ckeditor','placeholder'=>'Maker Comment')) }}
                                    </div>
                                      </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        {{ Form::textarea('checker_comment',@$program_details->checker_comment,array('class'=>'form-control ckeditor','placeholder'=>'Checker Comment')) }}
                                    </div>
                                   </div>
                                    ...
                                    <div class="col-md-10">
                                        {{ Form::textarea('other_details',@$program_details->other_details,array('class'=>'form-control ckeditor','placeholder'=>'other details')) }}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-2 col-sm-10">
