...
@section('breadcrumb')
    @parent
    <li class="active"><i class="fa fa-user"></i> Wallet Recharge</li>
@stop
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <div class="btn-toolbar">
                            <a href="{{route('cpanel.walletsrecharge.create')}}" class="btn btn-primary"
                               data-toggle="tooltip" title="Create New Recharge">
