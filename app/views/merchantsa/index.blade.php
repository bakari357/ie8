            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
			     ...
			     <th class="hidden-xs">Approved by</th>
                       ...
                       <tr> <?php $mer=$name=$customer->merchant_name; $email=$customer->email; $active=$customer->activated;?>
                            ...
                            <td>{{ HTML::linkRoute('cpanel.merchants.show',$email, array($customer->id)) }}</td>
                             <td class="hidden-xs">{{{ ($customer->active) ? 'yes' : 'no' }}}</td>
                            ...
                            <td> 
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a href="{{ route('cpanel.merchants.destroy', array($customer->id)) }}"
                                               data-method="delete"
