...
<div class="row">
    <div class="col-lg-12">
        <?php
        $option = array(
            'route' => array('cpanel.enterprise.update',$enterprise->id),
            'method' => 'put',
            'class' => 'form-horizontal'
        );
        ?>
        {{ Form::model($enterprise,$option) }}
       
       
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Edit Enterprise  &quot;{{ @$enterprise->name }}&quot;</h3>
                             </div>
            <div class="panel-body">
                <div class="tabbable">
                    ...
                    <ul class="nav nav-tabs" id="myTab">
                            <li class="active">
                                <a href="#credentials" data-toggle="tab">Main Description</a>
                            </li>
  <li>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="credentials">
                                <legend class="margin-top-10">Enterprise Informations</legend>
