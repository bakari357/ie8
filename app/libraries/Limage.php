...
class Limage extends Facade {
	 ...
	 * @return	void
	 */
	public function constructs($props = array())
	{
		if (count($props) > 0)
		{
		...
		Log::debug('debug', "Image Lib Class Initialized");
	}
	...
	{
		$err = array("imglib_source_image_required" => "You must specify a source image in your preferences.",
